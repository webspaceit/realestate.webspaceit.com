...
export default function Edit({ building }: { building: Building }) {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        setProcessing(true);
        router.put(`/buildings/${building.id}`, data, {
            onSuccess: () => {
    ...
    return (
        <>
            ...
            <div className="flex items-center gap-2 mb-6">
                ...
                <h1 className="text-2xl font-semibold">Edit Building</h1>
            </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div className="flex items-center gap-4">
                            <Button type="submit" disabled={processing}>
                                {processing ? 'Saving...' : 'Update Building'}
                            </Button>
                            <Link href="/buildings">
...
Edit.layout = (props: { building: Building }) => ({
    breadcrumbs: [
        { title: 'Dashboard', href: dashboard() },
        { title: 'Buildings', href: buildings.index() },
        { title: 'Edit', href: buildings.edit(props.building.id) },
    ],
});
