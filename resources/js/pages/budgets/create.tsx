...
import { index as budgetsIndex, store as budgetsStore } from '@/routes/budgets'
...
export default function BudgetCreate() {
    ...
    const [form, setForm] = useState({ project_id: '', phase_id: '', category: '', amount: '' })
    const [processing, setProcessing] = useState(false)

    function submit(e: React.FormEvent) {
        e.preventDefault()
        setProcessing(true)
        router.post(budgetsStore().url, {
            ...
            preserveState: true,
            preserveScroll: true,
            onSuccess: () => { toast.success('Budget created'); setProcessing(false) },
...
BudgetCreate.layout = {
    breadcrumbs: [
        ...
        { title: 'Create', href: budgetsIndex().url + '/create' },
    ],
}
