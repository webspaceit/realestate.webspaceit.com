...
export default function Edit() {
    const { task, phases, users } = usePage<Props>().props
    ...
    function handleSubmit(e: FormEvent) {
        e.preventDefault()
        setSubmitting(true)
        router.put(tasks.update.url({ task: task.id }), { ...form, phase_id: Number(form.phase_id), assigned_to: form.assigned_to ? Number(form.assigned_to) : null }, {
            preserveState: true, preserveScroll: true,
            onSuccess: () => { toast.success('Task updated'); setSubmitting(false) },
...
Edit.layout = (props: Props) => ({
    breadcrumbs: [
        ...
        { title: 'Edit', href: tasks.edit.url({ task: props.task.id }) },
    ],
})
